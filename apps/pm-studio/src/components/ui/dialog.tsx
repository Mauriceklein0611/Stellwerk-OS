  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // grid-cols-[minmax(0,1fr)]: the single column may shrink below its
          // content min-content, so a wide child never forces horizontal
          // overflow (grid items default to min-width:auto). Default width is a
          // comfortable sm:max-w-lg for forms; dense dialogs widen further.
